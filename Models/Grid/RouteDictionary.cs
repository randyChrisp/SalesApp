...
namespace SalesApp.Models
{
    public class RouteDictionary : Dictionary<string,string>
    {
        ...
        public void SetSortAndDirection(string fieldName, RouteDictionary current)
        {
            ...
            if (string.Equals(current.SortField, fieldName, StringComparison.InvariantCultureIgnoreCase) && current.SortDirection == "asc")
            {
        ...
        public void ClearFilters()
        {
            ...
            YearFilter = SalesGridDTO.DefaultFilter;
            QuarterFilter = SalesGridDTO.DefaultFilter;
        }
